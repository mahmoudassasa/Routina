...
class GoalOptimizationScreen extends StatefulWidget {
  final List<Map<String, dynamic>> habits;
  const GoalOptimizationScreen({super.key, required this.habits});

  @override
  State<GoalOptimizationScreen> createState() => _GoalOptimizationScreenState();
}

class _GoalOptimizationScreenState extends State<GoalOptimizationScreen> {
  String? _result;
  bool _loading = true;
  String? _error;
  ...
  Future<void> _load() async {
    ...
    try {
      final result = await GeminiService().getGoalOptimization(habits: widget.habits);
