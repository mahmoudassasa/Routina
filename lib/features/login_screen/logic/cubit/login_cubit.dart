...
Future<void> _ensurePremiumRecord(String uid) async {
  try {
    ...
    // تجاهل الخطأ (سيتم إنشاء السجل تلقائياً عند أول جلب للحالة)
  }
}
      ...
      try {
        ...
        if (!userDoc.exists) {
          await FirebaseFirestore.instance.collection('users').doc(uid).set({
            ...
            'imageUrl': credential.user!.photoURL ?? "https://gvqgliulacfmhscswyid.supabase.co/storage/v1/object/public/users/unknown.png",
