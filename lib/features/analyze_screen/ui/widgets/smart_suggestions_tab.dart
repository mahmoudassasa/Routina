...
class SmartSuggestionsTab extends StatefulWidget {
  const SmartSuggestionsTab({super.key});

  @override
  State<SmartSuggestionsTab> createState() => _SmartSuggestionsTabState();
}

class _SmartSuggestionsTabState extends State<SmartSuggestionsTab>
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              verticalSpace(8),
              Text(
                context.l10n.smartSuggestionsPremiumDesc,
                style: TextStyle(
                  fontSize: 13.sp,
                  ...
                  IconButton(
                    onPressed: state.remainingDailyRequests <= 0
                        ...
                        : () {
                            context
                                .read<AnalyticsCubit>()
                                .fetchGeminiInsights('smart', forceRefresh: true);
                          },
                    icon: Icon(
                      Icons.refresh,
